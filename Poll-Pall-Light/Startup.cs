...
using Poll_Pall_Light.Permission;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<QnAItemContext>(Options => Options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection"),
                b => b.MigrationsAssembly("Poll-Pall-Light")));
            services.AddDbContext<QItemContext>(Options => Options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection"),
                b => b.MigrationsAssembly("Poll-Pall-Light")));

            services.AddScoped<IAService, AService>();
            services.AddScoped<IQnAItemService, QnAItemService>();
